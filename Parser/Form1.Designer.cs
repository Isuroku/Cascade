namespace Parser
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnOpenNewFolder = new System.Windows.Forms.Button();
			this.SuspendLayout();
			// 
			// tbSourceText
			// 
			...
			// btnOpenNewFolder
			// 
			this.btnOpenNewFolder.Location = new System.Drawing.Point(877, 230);
			this.btnOpenNewFolder.Name = "btnOpenNewFolder";
			this.btnOpenNewFolder.Size = new System.Drawing.Size(119, 23);
			this.btnOpenNewFolder.TabIndex = 37;
			this.btnOpenNewFolder.Text = "Open New Folder";
			this.btnOpenNewFolder.UseVisualStyleBackColor = true;
			this.btnOpenNewFolder.Click += new System.EventHandler(this.btnOpenNewFolder_Click);
			// 
			// Form1
			// 
			...
			this.Controls.Add(this.btnOpenNewFolder);
		...
		private System.Windows.Forms.Button btnOpenNewFolder;
	}
}
